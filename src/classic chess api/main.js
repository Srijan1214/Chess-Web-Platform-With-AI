...
console.log(GameBoardObj.moveList[ GameBoardObj.moveListStart[GameBoardObj.ply] ])
console.log( GameBoardObj.PrMove(GameBoardObj.moveList[  GameBoardObj.moveListStart[GameBoardObj.ply]]))
GameBoardObj.MakeMove(GameBoardObj.moveList[ GameBoardObj.moveListStart[GameBoardObj.ply] ])
GameBoardObj.PrintBoard()
GameBoardObj.GenerateMoves()
GameBoardObj.PrintMoveList()
